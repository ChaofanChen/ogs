...
#include "MonolithicWellboreSimulatorFEM.h"
    ...
    unsigned const integration_order)
{
    ...
    _secondary_variables.addSecondaryVariable(
        ...
        makeExtrapolator(
            ...
            &WellboreSimulatorLocalAssemblerInterface::getIntPtDarcyVelocity));
}
...
void WellboreSimulatorProcess::preTimestepConcreteProcess(
    ...
    setCoupledTermForTheStaggeredSchemeToLocalAssemblers(int const process_id)
{
    ...
    GlobalExecutor::executeSelectedMemberOnDereferenced(
        &WellboreSimulatorLocalAssemblerInterface::setStaggeredCoupledSolutions,
        _local_assemblers, pv.getActiveElementIDs(), _coupled_solutions);
}

std::tuple<NumLib::LocalToGlobalIndexMap*, bool>
WellboreSimulatorProcess::getDOFTableForExtrapolatorData() const
{
    if (!_use_monolithic_scheme)
    {
...
void WellboreSimulatorProcess::setCoupledSolutionsOfPreviousTimeStepPerProcess(
    const int process_id)
{
...
void WellboreSimulatorProcess::setCoupledSolutionsOfPreviousTimeStep()
{
...
Eigen::Vector3d WellboreSimulatorProcess::getFlux(
